...
import { MusicElem } from "../../components/UI/MusicElem/MusicElelm";
...
const musicElemData = [
  ...
  {
    linkImg:"./img/music/album-2.png",
    mainText:"In the Wind",
    secondaryText:"On-The-Go",
  },
  {
    linkImg:"./img/music/album-3.png",
    mainText:"On you own",
    secondaryText:"Meltt",
  },
  {
    linkImg:"./img/music/album-4.png",
    mainText:"Infinity",
    secondaryText:"James Young",
  },
  {
    linkImg:"./img/music/album-5.png",
    mainText:"Let me follow",
    secondaryText:"Son Lux",
  },
  {
    linkImg:"./img/music/album-6.png",
    mainText:"Youth",
  ...
  return (
    ...
    <div className="MainPage">
      <aside className="LeftSide">
        ...
        <div className="List">
          <div className="List__title">
            <Heading headingType={"h1"} headingText="Подписки"/>
      ...
      <aside className="RightSide">
        <div className="List">
          <div className="List__title">
            <Heading headingType={"h2"} headingText="Близкие друзья"/>
            <span className="count">123</span>
          </div>
        {
          userFriendsData.map((elem)=>(
            <UserElem 
            linkImg={elem.linkImg} 
            mainText={elem.mainText} 
            secondaryText={elem.secondaryText}
        ...
        <div className="MusicBlock">
          <div className="MusicBlock__title">
            <Heading headingType={"h2"} headingText="Вы недавно слушали"/>
            <span>123</span>
          </div>
